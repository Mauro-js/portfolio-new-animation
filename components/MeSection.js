...
export default function MeSection({ show }) {
    ...
    return <>{ show ?
        <section id="meRef" className='text-center absolute sm:pt-8 w-full disaper mx-auto place-items-center m-2 sm:w-3/4'>
                <p
                ...
                >
                    Me
                        ...
                        <Card className="bg-spacial-2 m-5">
                            <CardBody className=" place-items-center sm:grid-flow-col text-2xl text-white">
                                <p className='p-4'>
